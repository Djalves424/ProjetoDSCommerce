...
public class UserServiceTests {
    ...
    @Test
    public void authenticatedShouldThrowUsernameNotFoundExceptionWhenUserDoesNotExit() {
    ...
    public void getMeShouldThrowUserNameNotFoundExceptionWhenUserNotAuthenticated() {
        ...
        UserService spyUserServicce = Mockito.spy(service);
        Mockito.doThrow(UsernameNotFoundException.class).when(spyUserServicce).authenticated();

        Assertions.assertThrows(UsernameNotFoundException.class, () -> {
            UserDTO result = spyUserServicce.getMe();
        });
    }
}
